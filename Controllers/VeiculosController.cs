...
namespace Aplicacao.Controllers
{
    public class VeiculosController : Controller
    {
        ...
        public VeiculosController(AplicacaoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Veiculos != null ? 
                          ...
                          Problem("Entity set 'AplicacaoContext.Veiculos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("NomeCarro,Ano,ValorFipe,Id")] Veiculos veiculos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NomeCarro,Ano,ValorFipe,Id")] Veiculos veiculos)
        {
            if (id != veiculos.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AplicacaoContext.Veiculos'  is null.");
            }
            var veiculos = await _context.Veiculos.FindAsync(id);
            if (veiculos != null)
            {
